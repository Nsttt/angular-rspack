...
describe('StyleUrlsResolver', () => {
  it('should return parse code and return styleUrlsPaths', () => {
    ...
    const spyGet = rs.spyOn(resolver.styleUrlsCache, 'get');
    // @ts-expect-error: Accessing private property for testing
    const spySet = rs.spyOn(resolver.styleUrlsCache, 'set');
    const code = `
      @Component({
        styleUrl: 'theme.scss',
...
describe('TemplateUrlsResolver', () => {
  it('should return parse code and return templateUrlPaths', () => {
    ...
    // @ts-expect-error: Accessing private property for testing
    const spyGet = rs.spyOn(resolver.templateUrlsCache, 'get');
    // @ts-expect-error: Accessing private property for testing
    const spySet = rs.spyOn(resolver.templateUrlsCache, 'set');
