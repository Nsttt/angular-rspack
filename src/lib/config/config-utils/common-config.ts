          ...
          use: [
            {
              loader: require.resolve(
                resolveInternalLoader(
                  '../../plugins/loaders/angular-transform.loader',
          ...
          use: [
            {
              loader: require.resolve(
                resolveInternalLoader(
                  '../../plugins/loaders/angular-partial-transform.loader',
...
function resolveInternalLoader(
  distRelativeRequest: string,
  sourceRelativePath: string
): string {
  const sourcePath = resolve(process.cwd(), sourceRelativePath);
  return existsSync(sourcePath) ? sourcePath : distRelativeRequest;
}
